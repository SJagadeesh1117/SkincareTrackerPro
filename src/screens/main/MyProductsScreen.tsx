...
export function MyProductsScreen() {
  // Stack nav for navigating to BundleScreen (child of MyProductsStack)
  const stackNav = useNavigation<StackNavigationProp<MyProductsStackParamList>>();

  // Helper: navigate to a drawer-level screen (e.g. FaceScan)
  function goToDrawerScreen(name: keyof MainDrawerParamList) {
    stackNav
  ...
  if (!skinType) {
    return <NoProfilePrompt onScan={() => goToDrawerScreen('FaceScan')} />;
  }
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.chipBar}>
        <TouchableOpacity
          ...
          onPress={() => goToDrawerScreen('FaceScan')}
          activeOpacity={0.8}>
  ...
  return (
    <View style={styles.centered}>
      <View style={styles.promptCard}>
        <MaterialCommunityIcons name="face-scan" size={56} color={TEAL} />
  ...
  return (
    <View style={styles.detailsPanel}>
      ...
      <View style={styles.instructionRow}>
        <MaterialCommunityIcons name="information-outline" size={14} color={TEAL} />
